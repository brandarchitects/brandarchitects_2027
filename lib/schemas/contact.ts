...
export const contactSchema = z.object({
  ...
  // Interessenfelder: Mehrfachauswahl (ADR-009). Ohne JavaScript kommt ein einzelner Wert als String – wird zu Array normalisiert.
  topics: z.preprocess((v) => (typeof v === "string" ? [v] : v), z.array(z.enum(contactTopics)).max(contactTopics.length)).optional(),
